...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Tabel Pembayaran Berhasil</h1>
        @if ($errors->any())
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        @endif
                                        <hr>
                                        <h5>Update Resi & Kirim Email Notifikasi</h5>
                                        <hr>
                                        <form class="forms-sample" action="{{ URL::to('adminPaymentSuccess/' . $order->id) }}" method="post">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group">
